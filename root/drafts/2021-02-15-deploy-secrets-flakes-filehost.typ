...
The full repository is [here](image), though I followed #link("https://github.com/SergioBenitez/Rocket/tree/master/examples/pastebin")[this] tutorial pretty closely. There's nothing too novel going on. I've got a GET endpoint:
...
we use #link("https://github.com/oxalica/rust-overlay")[rust-overlay].
...
will force later on) #link("https://stackoverflow.com/questions/4143196/is-get-data-also-encrypted-in-https#:~:text=10%20Answers&text=The%20entire%20request%20is%20encrypted,the%20destination%20address%20and%20port.&text=The%20entire%20response%20is%20also,intercept%20any%20part%20of%20it")[then the secret key shall be encrypted].

I won't go through the rust code to do this, but in order to test out the file host,
(it should be fairly self explanatory), but clone #link("https://github.com/DieracDelta/filehost_rust")[here]
...
A popular solution, independent of nix, is to use mozilla's #link("https://github.com/mozilla/sops")[`sops`]
tool. #link("https://github.com/Mic92/sops-nix")[Nix-sops] wraps this super easily.
...
the box. To do this, we write a #link("https://github.com/DieracDelta/flakes/blob/flakes/custom_modules/filehost.nix")[nixos module] that will automatically run our filehost.
