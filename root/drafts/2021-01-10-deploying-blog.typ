...
#link("https://github.com/DieracDelta/advent-of-code-2020")[haskell], and wanted to
configure my blog in haskell. This can be done through
#link("https://jaspervdj.be/hakyll/")[hakyll]. I get the same benefits that hugo
...
Luckily, #link("https://github.com/zarybnicky/zarybnicky.com/blob/master/flake.nix")[this guy]
...
is just in my #link("https://github.com/DieracDelta/DieracDelta.github.io/blob/master/flake.nix")[`flake.nix`]
file.
...
using the process described #link("https://mpickering.github.io/posts/2019-06-24-overkill-or-not.html")[here] and #link("https://github.com/rpearce/hakyll-nix-template")[here]. Note that I didn't realize
...
- Use the #link("https://github.com/cachix/install-nix-action")[`cachix/install-nix-action`] to install nix flakes.
- Run the `nix build . -o site` to build the flake and put the result in
  the `site` subdirectory.
- Use #link("https://github.com/crazy-max/ghaction-github-pages")[crazy-max]
