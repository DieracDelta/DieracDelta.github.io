...
The bibliography is fairly standard. I was able to generate bibtex citations off #link("https://scholar.google.com")[google scholar]. I then copy and pasted them into my ref.bib file and at the end of my document included a \bibliography{ref} call. I also needed to specify a style (before the bibliography tag). I used `\bibliographystyle{unsrturl}`, which looked fine.
